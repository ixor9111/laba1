...
namespace laba1.Controllers
{
    public class FilesController : Controller
    {
        ...
        public FilesController(laba1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FileID,Link,Format")] File file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FileID,Link,Format")] File file)
        {
            if (id != file.FileID)
            {
                return NotFound();
